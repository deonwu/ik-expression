...
public class Op_APPEND implements IOperatorExecution {
	...
	private Constant append(Constant arg1 , Constant arg2){
		...
		//合并参数一
		if(DataType.DATATYPE_COLLECTION == arg1.getDataType()){
		...
		//合并参数二
		if(DataType.DATATYPE_COLLECTION == arg2.getDataType()){
		...
		//构造新的collection 常量
		Constant result = new Constant(BaseDataMeta.DataType.DATATYPE_COLLECTION , resultCollection);
		return result;
	}	
